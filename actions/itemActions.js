...
export function syncItemsCsv(){
  ...
  return (dispatch) => {
    ...
    Alert.alert(
      "SYNC ITEMS & ITEM SECTIONS",
      "This update all apps items info and item sections",
      [
        { text: "Start Sync",  onPress: () => syncItems() },
        { text: 'Cancel', onPress: console.log('Sync Items CSV canceled') }
      ],
      { cancelable: false }
    )
